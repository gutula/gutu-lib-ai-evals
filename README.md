...
| Primary focus | evaluation helpers, baseline comparisons, AI verification |
...
- This repo currently publishes `@platform/ai-evals` as the legacy compatibility package id while the migration to `@gutu/ai-evals` is completed.
